...
export const searchTerms: SearchTermType[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            hasEvidence: true,
            description:
              'Search by biophysicochemical properties: kinetic parameters',
            example: 'aspartate',
          },
          {
            id: 'id_bpcp_ph_dependence',
            label: 'ph dependence',
            itemType: 'comment',
            term: 'bpcp_ph_dependence',
            dataType: 'string',
            hasEvidence: true,
            description:
              'Search by biophysicochemical properties: ph dependence',
            example: 'optimum',
          },
          {
            id: 'id_bpcp_redox_potential',
            label: 'Redox potential',
            itemType: 'comment',
            term: 'bpcp_redox_potential',
            dataType: 'string',
            hasEvidence: true,
            description:
              'Search by biophysicochemical properties: redox potential',
            example: 'siroheme',
          },
          {
            id: 'id_bpcp_temp_dependence',
            label: 'Temperature dependence',
            itemType: 'comment',
            term: 'bpcp_temp_dependence',
            dataType: 'string',
            hasEvidence: true,
            description:
              'Search by biophysicochemical properties: tempeature dependence',
            example: '*',
          },
        ],
      },
      {
        id: 'id_catalytic_activity',
        label: 'Catalytic Activity',
        itemType: 'comment',
        term: 'catalytic_activity',
        dataType: 'string',
        hasEvidence: true,
      ...
      {
        id: 'id_enzyme_regulation',
        label: 'Activity regulation',
        itemType: 'comment',
        term: 'enzyme_regulation',
        dataType: 'string',
        hasEvidence: true,
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'id_disruption_phenotype',
        label: 'Disruption phenotype',
        itemType: 'comment',
        term: 'disruption_phenotype',
        dataType: 'string',
        hasEvidence: true,
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'id_group_molecule_processing',
        label: 'Molecule Processing [FT]',
        itemType: 'group',
        dataType: 'string',
        items: [
          {
            id: 'id_molecule_processing',
            label: 'Any molecule processing',
            itemType: 'feature',
            term: 'molecule_processing',
            dataType: 'string',
            hasRange: true,
            hasEvidence: true,
  ...
  {
    id: 'id_group_expression',
    label: 'Expression',
    itemType: 'group',
    dataType: 'string',
    items: [
      {
        id: 'id_developmental_stage',
        label: 'Developmental stage',
        itemType: 'comment',
        term: 'developmental_stage',
        dataType: 'string',
        hasEvidence: true,
      ...
      {
        id: 'id_tissue_specificity',
        label: 'Tissue specificity',
        itemType: 'comment',
        term: 'tissue_specificity',
        dataType: 'string',
        hasEvidence: true,
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'id_group_secondary_structure',
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'id_group_alternative_products',
        ...
        items: [
          ...
          },
          {
            ...
            hasEvidence: true,
            description:
              'Search by Comment alternative Products: alternative promoter usage',
            example: '*',
          },
          {
            id: 'id_ap_as',
            ...
            hasEvidence: true,
            description:
              'Search by Comment alternative Products: alternative splicing',
          ...
          },
          {
            ...
            hasEvidence: true,
            description:
              'Search by Comment alternative Products: alternative initiation',
          ...
          },
          {
            ...
            hasEvidence: true,
            description:
              'Search by Comment alternative Products: ribosomal frameshifting',
            example: 'translation',
          },
        ],
      },
      {
        id: 'id_group_sequence_caution',
        ...
        items: [
          ...
          },
          {
            ...
            hasEvidence: false,
            description:
              'Search by Comment Sequence caution: erroneous initiation',
            example: 'extended',
          },
          {
            id: 'id_sc_eterm',
            ...
            hasEvidence: false,
            description:
              'Search by Comment Sequence caution: erroneous termination',
            example: 'translated',
          },
          {
            id: 'id_sc_epred',
            ...
            hasEvidence: false,
            description:
              'Search by Comment Sequence caution: erroneous gene model prediction',
            example: '*',
          },
          {
            id: 'id_sc_etran',
            ...
            hasEvidence: false,
            description:
              'Search by Comment Sequence caution: erroneous translation',
            example: 'choice',
          },
          {
            id: 'id_sc_misc',
            ...
            hasEvidence: true,
            description:
              'Search by Comment Sequence caution: miscellaneous discrepancy',
            example: 'sequence',
          },
        ],
      },
      {
        id: 'id_mass_spectrometry',
        label: 'Mass spectrometry',
        itemType: 'comment',
        term: 'mass_spectrometry',
        dataType: 'string',
        hasEvidence: true,
      ...
      {
        id: 'id_group_natural_variations',
      ...
      },
      {
        ...
        term: 'organelle',
        dataType: 'string',
        autoComplete: '/uniprot/api/suggester?dict=organelle&query=?',
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'id_group_sequence_databases',
      ...
      {
        id: 'id_group_3d_structure_databases',
        ...
        items: [
          ...
          {
            id: 'id_xref_proteinmodelportal',
            label: 'ProteinModelPortal',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'proteinmodelportal',
          },
          {
            id: 'id_xref_smr',
            label: 'SMR',
      ...
      {
        id: 'id_group_protein_protein_interaction_databases',
        ...
        items: [
          ...
          {
            id: 'id_xref_stringxref',
            label: 'STRING',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'stringxref',
          },
        ],
      },
      {
        id: 'id_group_chemistry',
        label: 'Chemistry',
        itemType: 'group',
        dataType: '',
        items: [
          {
            id: 'id_xref_bindingdb',
            label: 'BindingDB',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
          ...
          {
            id: 'id_xref_guidetopharmacology',
      ...
      {
        id: 'id_group_protein_family_group_databases',
        label: 'Protein family/group databases',
        itemType: 'group',
        dataType: '',
        items: [
          {
            id: 'id_xref_allergome',
            label: 'Allergome',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
          ...
          {
            id: 'id_xref_imgt_gene_db',
            label: 'IMGT_GENE-DB',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'imgt_gene_db',
          },
          {
            id: 'id_xref_merops',
            label: 'MEROPS',
          ...
          },
          {
            ...
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'mycoclap',
          },
          {
            id: 'id_xref_peroxibase',
            label: 'PeroxiBase',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
      ...
      {
        id: 'id_group_ptm_databases',
        label: 'PTM databases',
        itemType: 'group',
        dataType: '',
        items: [
          {
            id: 'id_xref_carbonyldb',
            label: 'CarbonylDB',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
      ...
      {
        id: 'id_group_polymorphism_and_mutation_databases',
      ...
      {
        id: 'id_group_2d_gel_databases',
        label: '2D gel databases',
        itemType: 'group',
        dataType: '',
        items: [
          {
            id: 'id_xref_compluyeast2dpage',
            label: 'COMPLUYEAST-2DPAGE',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'compluyeast2dpage',
          },
          {
            id: 'id_xref_dosaccobs2dpage',
            label: 'DOSAC-COBS-2DPAGE',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'dosaccobs2dpage',
          },
          {
            id: 'id_xref_ogp',
            label: 'OGP',
          ...
          {
            id: 'id_xref_reproduction2dpage',
            label: 'REPRODUCTION-2DPAGE',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'reproduction2dpage',
          },
          {
            id: 'id_xref_swiss2dpage',
            label: 'SWISS-2DPAGE',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'swiss2dpage',
          },
          {
            id: 'id_xref_ucd2dpage',
            label: 'UCD-2DPAGE',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'ucd2dpage',
          },
          {
            id: 'id_xref_world2dpage',
            label: 'World-2DPAGE',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'world2dpage',
          },
        ],
      },
      {
        id: 'id_group_proteomic_databases',
      ...
      {
        id: 'id_group_protocols_and_materials_databases',
      ...
      {
        id: 'id_group_genome_annotation_databases',
      ...
      {
        id: 'id_group_organism_specific_databases',
        label: 'Organism-specific databases',
        itemType: 'group',
        dataType: '',
        items: [
          {
            id: 'id_xref_arachnoserver',
            label: 'ArachnoServer',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
      ...
      {
        id: 'id_group_phylogenomic_databases',
        ...
        items: [
          ...
          },
          {
            ...
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'hovergen',
          },
          {
            id: 'id_xref_inparanoid',
            label: 'InParanoid',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
      ...
      {
        id: 'id_group_enzyme_and_pathway_databases',
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: 'id_xref_pmapcutdb',
            label: 'PMAP-CutDB',
            itemType: 'database',
            term: 'xref',
            dataType: 'string',
            valuePrefix: 'pmapcutdb',
          },
          {
            id: 'id_xref_pro',
            label: 'PRO',
      ...
      {
        id: 'id_group_gene_expression_databases',
      ...
      {
        id: 'id_group_family_and_domain_databases',
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'id_sequence_modified',
        label: 'Date of last sequence modification',
        itemType: 'single',
        term: 'sequence_modified',
        dataType: 'date',
        hasRange: true,
    ...
    items: [
      {
        ...
        term: 'lit_citation',
        dataType: 'string',
        description: 'Search by title or abstract',
        example: 'somevalue',
      },
      {
        id: 'id_lit_author',
